...
type RateRequest struct {
	...
	Quote Currencies `protobuf:"varint,2,opt,name=Quote,proto3,enum=currency.Currencies" json:"Quote,omitempty"`
}
...
func (x *RateRequest) GetQuote() Currencies {
	if x != nil {
		return x.Quote
	}
	return Currencies_EUR
...
var file_currency_proto_rawDesc = []byte{
	...
	0x12, 0x08, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x63, 0x79, 0x22, 0x63, 0x0a, 0x0b, 0x52, 0x61,
	...
	0x61, 0x73, 0x65, 0x12, 0x2a, 0x0a, 0x05, 0x51, 0x75, 0x6f, 0x74, 0x65, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x0e, 0x32, 0x14, 0x2e, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x63, 0x79, 0x2e, 0x43, 0x75,
	0x72, 0x72, 0x65, 0x6e, 0x63, 0x69, 0x65, 0x73, 0x52, 0x05, 0x51, 0x75, 0x6f, 0x74, 0x65, 0x22,
...
var file_currency_proto_depIdxs = []int32{
	...
	0, // 1: currency.RateRequest.Quote:type_name -> currency.Currencies
